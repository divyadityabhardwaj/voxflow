...
// startPositionWatch starts a goroutine to poll and save window position in mini mode
func (a *App) startPositionWatch() {
	a.startWindowWatch(true)
}
...
func (a *App) startMaximizedPositionWatch() {
	a.startWindowWatch(false)
}

// startWindowWatch consolidated position watcher loop for both mini and standard/maximized window modes
func (a *App) startWindowWatch(isMini bool) {
	if a.positionWatchCancel != nil {
		a.positionWatchCancel()
	}
